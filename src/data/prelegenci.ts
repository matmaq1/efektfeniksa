...
export const speakers: Speaker[] = [
  ...
  },
  {
    ...
    title: "Wywiad z Ewą Turek: Poniosłam porażkę. I całe szczęście.",
    micro: "Nie każda porażka jest końcem drogi. Czasem jest początkiem historii, której nie potrafimy sobie nawet wyobrazić. Rozmowę prowadzi Michał Czarniewski.",
    desc: [],
    intro: [],
    tm: [],
    misjaLabel: "Misja",

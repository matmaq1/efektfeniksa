...
export const agenda: AgendaDay[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { time: '16:00-16:45', room: '', kind: 'scena', title: 'Gość specjalny', tbc: true,
        note: 'Nazwisko i sala zostaną ogłoszone wkrótce.' },
  ...
  },
  {
    ...
    items: [
      ...
      { time: '11:00-11:45', room: 'Warsztatowa I', kind: 'prelekcja', speaker: 'agnieszka-ciochon', tbc: true },
      { time: '11:00-11:45', room: 'Warsztatowa I', kind: 'prelekcja', speaker: 'eliza-krzak', tbc: true },
      ...
      { time: 'godzina wkrótce', room: 'AULA', kind: 'prelekcja', speaker: 'anna-kaldonek', tbc: true },
